                ...
                <div className="agendamento-form-container">
                    ...
                    <div className="input-container">
                        ...
                        <div className="tempo-container">
                            <NumberPicker placeholder="Horas" className="number-picker" ></NumberPicker>
                            <NumberPicker placeholder="Minutos" className="number-picker"></NumberPicker>
                        </div>
                    </div>
                    <h1 className="agendamento-title">2. Detalhes da Impressão</h1>
                    <div className="input-container">
                        <p className="label">Nome do Projeto: </p>
                        <Input placeholder="Ex: Peça para apoio de celular." className="antd-input" />
                        ...
                        <Dragger className="dragger-container">
                            ...
                            <p className="dragger-info">Envie um arquivo que mostre claramente o que deseja imprimir, em formato pdf ou imagem. <br />
                                (.pdf, .png, .jpeg, etc.)
                            </p>
                        ...
                        <TextArea rows={4} placeholder="Escreva uma breve descrição do projeto:" className="antd-input" />
                    </div>
                    <button className="default-button">Enviar Projeto</button>
                </div>
